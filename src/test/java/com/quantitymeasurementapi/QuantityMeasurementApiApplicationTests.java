...
class QuantityMeasurementApiApplicationTests {
    ...
    private QuantityMeasurement mockController;

    @BeforeEach
    void setUp() {
        mockController = mock(QuantityMeasurement.class);
    }
    ...
    @Test
    public void givenOneYardAndOneYard_WhenCompered_ShouldReturnTrue() {
        try {
    ...
    @Test
    public void givenOneYardAndOneYard_WhenMock_ShouldReturn() {
        try {
            QuantityMeasurement measurementModel1 = new QuantityMeasurement(1.0,UnitOfLength.YARD);
            QuantityMeasurement yard1 = new QuantityMeasurement(1.0, UnitOfLength.YARD);
            when(mockController.compare(measurementModel1)).thenReturn(true);
            QuantityMeasurement yard2 = new QuantityMeasurement(1.0, UnitOfLength.YARD);
            QuantityMeasurement measurementModel2 = new QuantityMeasurement(1.0,UnitOfLength.YARD);
            when(mockController.compare(measurementModel2)).thenReturn(true);
            Boolean compareCheck = yard2.compare(yard1);
            Assert.assertTrue(compareCheck);
        } catch (QuantityMeasurementException e) {
        }
    }
